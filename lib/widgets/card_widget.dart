          ...
          Positioned(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(LocaleKeys.your_minutes.tr(), style: const TextStyle(fontSize: 13, color: Colors.white, letterSpacing: 5)),
                    Text(prov.minutes.toString(),
                        style: TextStyle(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14, letterSpacing: 5),
                    ),
                    Text(
                      '9124 1245 4724 2457',
